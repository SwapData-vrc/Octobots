...
ez::Drive chassis(
    ...
    {-5, -4, -2},     // Left Chassis Ports (negative port will reverse it!)
    {7, 6, 8},  // Right Chassis Ports (negative port will reverse it!)
...
if (master.get_digital_new_press(DIGITAL_B)) {
  PPosition = !PPosition;
  OuttakePiston.set_value(!PPosition);  // Notice the extra !
}
else if (master.get_digital_new_press(DIGITAL_DOWN)) {
  YPosition = !YPosition;
  IntakePiston.set_value(!YPosition);  // Notice the extra !
}
